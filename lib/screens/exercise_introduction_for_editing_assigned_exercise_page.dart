...
class ExerciseIntroductionForEditingAssignedExercisePageWidget
  ...
  @override
  _ExerciseIntroductionForEditingAssignedExercisePageWidgetState
      createState() =>
          _ExerciseIntroductionForEditingAssignedExercisePageWidgetState();
}

class _ExerciseIntroductionForEditingAssignedExercisePageWidgetState
    extends State<ExerciseIntroductionForEditingAssignedExercisePageWidget> {
  var subscription;
  ...
  void initState() {
    ...
    exerciseNumberOfTimes = widget.exerciseNumberOfTimes;
    exerciseNumberOfSets = widget.exerciseNumberOfSets;
  ...
  Widget actionButtonContainer(BuildContext context) {
    return Container(
      width: double.infinity,
