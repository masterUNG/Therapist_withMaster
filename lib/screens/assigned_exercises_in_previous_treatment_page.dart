...
class AssignedExercisesInPreviousTreatmentPageWidget extends StatefulWidget {
  ...
  AssignedExercisesInPreviousTreatmentPageWidget(
      {Key key, @required this.treatmentID})
      : super(key: key);
  ...
  Widget assignedExercisesList() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) => assignedExercisesContainer(
          context, index, assignedExercisesListWithExercisesModel[index]),
    );
  }
  ...
  Widget assignedExercisesContainer(
    ...
    return Column(
      children: [
        ...
        index == this.assignedExercisesListWithExercisesModel.length - 1
            ? SizedBox(height: 12)
            : Container(),
      ],
    );
