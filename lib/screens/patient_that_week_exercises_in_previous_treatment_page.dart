...
class PatientThatWeekExercisesInPreviousTreatmentPageWidget
  ...
  const PatientThatWeekExercisesInPreviousTreatmentPageWidget(
      {Key key,
  ...
  @override
  _PatientThatWeekExercisesInPreviousTreatmentPageWidgetState createState() =>
      _PatientThatWeekExercisesInPreviousTreatmentPageWidgetState();
}

class _PatientThatWeekExercisesInPreviousTreatmentPageWidgetState
    extends State<PatientThatWeekExercisesInPreviousTreatmentPageWidget> {
  var subscription;
  ...
  void initState() {
    ...
    patientProfileImage = widget.patientUserProfileImage;
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              date.isBefore(treatmentFinishDate) == true
                  ? Expanded(
                      child: Align(
