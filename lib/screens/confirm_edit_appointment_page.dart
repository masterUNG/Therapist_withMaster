...
class ConfirmEditAppointmentPageWidget extends StatefulWidget {
  ...
  ConfirmEditAppointmentPageWidget(
      {Key key,
  ...
  @override
  _ConfirmEditAppointmentPageWidgetState createState() =>
      _ConfirmEditAppointmentPageWidgetState();
}

class _ConfirmEditAppointmentPageWidgetState
    extends State<ConfirmEditAppointmentPageWidget> {
  var subscription;
  ...
  final editedAppointmentSuccessfullySnackBar = SnackBar(
    content: Text(
      'แก้ไขการนัดหมายเรียบร้อยแล้ว',
  ...
  Future<Null> editAppointment() async {
    showDialog(
      barrierDismissible: false,
      context: context,
      builder: (context) => ProgressDialog(title: 'กำลังแก้ไขการนัดหมาย'),
    );
    ...
    await Firebase.initializeApp().then((value) async {
      ...
      data['finishTime'] = Timestamp.fromDate(finishTime);
      ...
      await FirebaseFirestore.instance
        ...
        PatientNotificationsModel patientNotificationsModel =
            PatientNotificationsModel(
                ...
                title: 'การนัดหมายถูกแก้ไข',
                body: '$therapistName ได้แก้ไขการนัดหมาย',
  ...
  Future<Null> sendNotification(String therapistName) async {
    await Firebase.initializeApp().then((value) async {
      await FirebaseFirestore.instance
        ...
        for (var item in tokens) {
          String token = item;
          String title = 'การนัดหมายถูกแก้ไข';
          String body = '$therapistName ได้แก้ไขการนัดหมาย';
          String url =
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(editedAppointmentSuccessfullySnackBar);
